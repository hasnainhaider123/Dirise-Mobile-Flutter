class AppleLoginModel {
 ...
 dynamic token;
  ...
  AppleLoginModel({this.status, this.message, this.token, this.user});
...
class User {
 ...
 dynamic subscriptionStatus;
  ...
  dynamic icarryLocationId;
  dynamic featureVendor;
 dynamic createdAt;
 dynamic updatedAt;
  dynamic deletedAt;
 dynamic loginMethod;
  ...
  User.fromJson(Map<String, dynamic> json) {
    ...
    icarryLocationId = json['icarry_location_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['icarry_location_id'] = this.icarryLocationId;
