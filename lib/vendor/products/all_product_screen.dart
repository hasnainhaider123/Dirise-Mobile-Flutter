            ...
            child: Column(children: [
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: DropdownButton<String>(
                    isExpanded: true,
                    hint: Text('All'.tr,style: TextStyle(color:  Colors.black),),
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: DropdownButton<String>(
                    isExpanded: true,
                    hint: Text('الجميع'.tr,style: TextStyle(color:  Colors.black),),
                    value:productController.selectedValue1,
                    onChanged: (String? newValue) {
                      setState(() {
                        productController.getProductList1(context: context);
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text('${'QTY'.tr}: ${item.inStock} ${'piece'.tr}',
                                            style: normalStyle,
                                          ),
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Text(
                                                profileController.selectedLAnguage.value == "English"
                                                ?"${("${item.productType ?? ""}".capitalize!).toString().replaceAll("_product".tr, "")
                                                    .replaceAll("Single".tr, "Simple".tr).replaceAll("Variants".tr, "Variable".tr).replaceAll("Booking".tr, "Bookable".tr)} Product".tr
                                                :" منتج ${("${item.productType ?? ""}".capitalize!).toString().replaceAll("_product".tr, "")
                                                    .replaceAll("single".tr, "بسيط".tr).replaceAll("variants".tr, "عامل".tr).replaceAll("booking".tr, "قابل للحجز".tr)}".tr,
                                                style: GoogleFonts.poppins(
                                                  color: AppTheme.buttonColor,
                                                  fontWeight: FontWeight.w500,
                                                  fontSize: 15,
