...
import '../extendedPrograms/review_screen_academic.dart';
...
class _AcademicDurationScreenState extends State<AcademicDurationScreen> {
  ...
  createSlots() {
    ...
    map['preparation_block_time_type'] = preparationTime.toString();
    map['recovery_block_time_type'] = recoveryTime.toString();
    repositories.postApi(url: ApiUrls.productCreateSlots, mapData: map, context: context,showResponse: true).then((value) {
  ...
  void initState() {
    ...
    if (widget.id != null) {
      ...
      timeControllerPreparation.text = widget.preparationBlockTime.toString();
       startShowText = widget.interval.toString();
       startEndText  =  widget.preparationBlockTime.toString();
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Expanded(
                      child: CommonTextField(
                        ...
                        onEditingCompleted: () {
                          setState(() {
                            startShowText = timeController.text.toString();
                          });
                        },
                      )
                  ),
                ...
                children: [
                  ...
                  Expanded(
                      child: CommonTextField(
                        ...
                        onEditingCompleted: () {
                          setState(() {
                            startEndText = timeControllerPreparation.text.toString();
                          });
                        },
                      )
                  ),
              ...
              20.spaceY,
              Text('Your slot will be divided into ${startShowText.toString()} and customer will see ${startEndText.toString()} minuets slot '.tr,
                  style: GoogleFonts.poppins(
                    fontSize: 16,
                    fontWeight: FontWeight.w500,
                    color: const Color(0xff423E5E),
