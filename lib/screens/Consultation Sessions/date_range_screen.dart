              ...
              Row(
                ...
                children: [
                  Expanded(
                    ...
                    children: [
                      Text(
                        '${"Start Date:".tr} ${formattedStartDateVacation ?? ''}',
                        style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w500),
                      ),
                      10.spaceY,
                      ElevatedButton(
                  ...
                  Expanded(
                    ...
                    children: [
                      Text(
                        '${"End Date:".tr} ${formattedStartDate1Vacation ?? ''}',
                        style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w500),
                      ),
                      const SizedBox(height: 10),
                      ElevatedButton(
              ...
              InkWell(
                onTap: () {
                  ...
                  if (formKey.currentState!.validate()) {
                    if (formattedStartDate1Vacation != '' &&
                        formattedStartDateVacation != '' &&
                        formattedStartDate1 != '' && formattedStartDate != '') {
                      updateProfile();
                    }else{
                      showToastCenter('Please select dates'.tr);
                    }
                  }
