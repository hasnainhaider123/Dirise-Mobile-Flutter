...
class _ProductUIState extends State<ProductUI> {
    ...
    repositories
      ...
      if (response.status == true) {
        ...
        wishListController.favoriteItems
            .add(widget.productElement.id.toString());
  ...
  removeFromWishList() {
    repositories
      ...
      if (response.status == true) {
        wishListController.getYourWishList();
        wishListController.favoriteItems.removeWhere(
            (element) => element == widget.productElement.id.toString());
        wishListController.updateFav;
      }
    });
  }
  ...
  directBuyProduct() {
    ...
    map["zip_code"] = cartController.zipCode == ''
        ? locationController.zipcode.value.toString()
        : cartController.zipCode.toString();
    if (isBookingProduct) {
      map["start_date"] = selectedDate.text.trim();
      map["time_sloat"] = selectedSlot.split("--").first;
      map["sloat_end_time"] = selectedSlot.split("--").last;
    ...
    repositories
      ...
      profileController.selectedLAnguage.value == "English"
          ? showToast(
              cartController.directOrderResponse.value.message.toString())
          : showToast("نجاح");
      print(
          "Toast---: ${cartController.directOrderResponse.value.message.toString()}");
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        log('moving to another ${widget.productElement.itemType} and ${widget.productElement.productType} ');

        if (widget.productElement.itemType == 'giveaway') {
          log('i am 1');
          Get.to(() => const GiveAwayProduct(),
              arguments: widget.productElement.id.toString());
        } else if (widget.productElement.productType == 'variants' &&
            widget.productElement.itemType == 'product') {
          log('i am 2');
          ...
          Get.to(() => const BookableProductScreen(),
              arguments: widget.productElement.id.toString());
        } else if (widget.productElement.productType == 'virtual_product' &&
            widget.productElement.itemType == 'virtual_product') {
          log('i am 4');
          Get.to(() => VritualProductScreen(),
              arguments: widget.productElement.id.toString());
        } else if (widget.productElement.itemType == 'product' &&
            widget.productElement.showcaseProduct != true) {
          log('i am 5');
                  ...
                  children: [
                    ...
                    Text(
                      widget.productElement.shortDescription != null
                          ...
                          : widget.productElement.longDescription ?? '',
                      maxLines: 2,
                      style: GoogleFonts.poppins(
                          fontSize: 12,
                    ...
                    widget.productElement.itemType != 'giveaway'
                        ? Row(
                            children: [
                              widget.productElement.discountOff != '0.00'
                                  ? Flexible(
                                      child: Text.rich(profileController
                                                  .selectedLAnguage.value ==
                                              "English"
                                          ? TextSpan(
                                              text:
                                                  '${widget.productElement.pPrice.toString().split('.')[0]}.',
                                              style: GoogleFonts.poppins(
                              ...
                              Flexible(
                                child: Text.rich(profileController
                                    ...
                                    ? TextSpan(
                                        text:
                                            '${widget.productElement.discountPrice.toString().split('.')[0]}.',
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (Platform.isAndroid)
                                widget.productElement.itemType != 'service' &&
                                        widget.productElement.itemType !=
                                            'virtual_product'
                                        ...
                                        onTap: () async {
                                          SharedPreferences preferences =
                                              await SharedPreferences
                                                  .getInstance();
                                          hasShownDialog = preferences
                                                  .getBool('hasShownDialog') ??
                                              false;
                              ...
                              widget.productElement.itemType != 'giveaway'
                                  ? Row(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            int inStock = int.tryParse(widget
                                                    .productElement.inStock) ??
                                                0;
                                            if (inStock == -1) {
                                              setState(() {
                                                productQuantity.value++;
                    ...
                    Row(children: [
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () {
                            if (widget.productElement.productType ==
                                'variants') {
                              bottomSheet(
                                  productDetails: widget.productElement,
                                  context: context);
                            } else if (widget.productElement.productType ==
                                'booking') {
                              Get.to(() => const BookableProductScreen(),
                                  arguments:
                                      widget.productElement.id.toString());
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          // Text(
                                          //   widget.productElement.catId.toString(),
                                          //   maxLines: 1,
                                          //   overflow: TextOverflow.ellipsis,
                                          //   style: GoogleFonts.poppins(
                                          //       fontSize: 12,
