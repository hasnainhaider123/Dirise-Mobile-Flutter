                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('${"Meeting will be at :".tr} ${productDetailsModel.value.productDetails!.product!.meeting_platform ?? ""} '),
                            ...
                            Text('${"Extra Notes :".tr} ${productDetailsModel.value.productDetails!.product!.timingExtraNotes ?? ""}'),
                            Text('${"Spots :".tr} ${productDetailsModel.value.productDetails!.product!.spot ?? ""}'),
                            ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return Column(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('${"Start Time :".tr} ${productWeeklyAvailability.timeSloat ?? ""}'),
                                      Text('${"End time :".tr} ${productWeeklyAvailability.timeSloatEnd ?? ""}'),
                                    ],
                                  );
                                }),
                          ],
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('${"Virtual Location:".tr} ${productDetailsModel.value.productDetails!.product!.program_desc ?? ""}'),
                            Text('${"Link to enter:".tr} ${productDetailsModel.value.productDetails!.product!.program_desc ?? ""}'),
                            Text('${"Link will be send via:".tr} ${productDetailsModel.value.productDetails!.product!.program_desc ?? ""}'),
                          ],
                        ),
                      ),
                      Positioned(
