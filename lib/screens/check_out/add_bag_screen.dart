                                                                      ...
                                                                      ? IconButton(
                                                                          onPressed:
                                                                            ...
                                                                            if (product.qty.toString().toNum >
                                                                                1) {
                                                                              cartController.updateCartQuantity(context: context, productId: product.id.toString(), quantity: (product.qty.toString().toNum - 1).toString());
                                                                            } else {
                              ...
                              Expanded(
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                          "KWD ${cartController.cartModel.subtotal}",
                                          maxLines: 1,
