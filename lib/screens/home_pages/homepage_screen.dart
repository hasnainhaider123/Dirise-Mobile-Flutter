...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    print("Live Location-----: ${locationController.city.toString()}, ${locationController.zipcode ?? ''} ");
    print("Location-----: ${serviceController.cityController1.text.toString()}, ${serviceController.stateController1.text.toString()}, ${serviceController.countryController1.text ?? ''} ");
    ...
    Future.delayed(const Duration(seconds: 7), () {
      SchedulerBinding.instance.addPostFrameCallback((timeStamp) {
        ...
        if(locationController.addressListModel.value.defaultAddress != null){
          ...
          cartController.city.value  = locationController.addressListModel.value.defaultAddress!.city;
              ...
              child: AlertDialog(
                ...
                actions: [
                  TextButton(
                      ...
                      child: Platform.isAndroid ? Text("Exit App".tr) : Text("Do not allow".tr)
                  ),
                  TextButton(
                    onPressed: () async {
