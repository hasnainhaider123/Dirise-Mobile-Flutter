...
class _VritualProductScreenState extends State<VritualProductScreen> {
  ...
  getProductDetails({BuildContext? context}) {
    ...
    repositories.postApi(url: ApiUrls.singleVirtualProductUrl, mapData: {
      "product_id": id.toString(),
      "key": 'fedexRate',
      "is_def_address": homeController.defaultAddressId.toString()
    }).then((value) {
      modelSingleProduct.value =
          VritualProductModel.fromJson(jsonDecode(value));
      if (modelSingleProduct.value.singleVirtualProduct != null) {
        ...
        imagesList.addAll(
            modelSingleProduct.value.singleVirtualProduct!.galleryImage ?? []);
        ratingRills = ratingRill *
            double.parse(modelSingleProduct.value.singleVirtualProduct!.rating
                .toString());
        imagesList = imagesList.toSet().toList();
        if (modelSingleProduct.value.singleVirtualProduct!.catId != null &&
            modelSingleProduct.value.singleVirtualProduct!.catId!.isNotEmpty) {
          releatedId = modelSingleProduct
              .value.singleVirtualProduct!.catId!.last.id
              .toString();
        }
                ...
                child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            if (modelSingleProduct
                                    .value.singleVirtualProduct!.discountOff !=
                                '0.00')
                              Container(
                        ...
                        Text(
                          modelSingleProduct.value.singleVirtualProduct!.pname
                              .toString()
                              .capitalize!,
                          style: GoogleFonts.poppins(
                              fontWeight: FontWeight.w500,
                        ...
                        Text(
                          modelSingleProduct
                              .value.singleVirtualProduct!.shortDescription
                              .toString()
                              .capitalize!,
                          style: GoogleFonts.poppins(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text.rich(
                                TextSpan(
                                  text:
                                      '${modelSingleProduct.value.singleVirtualProduct!.discountPrice.toString().split('.')[0]}.',
                                  style: const TextStyle(
                                      fontSize: 24,
                                      fontWeight: FontWeight.w600,
                                      color: Color(0xFF19313B)),
                        ...
                        modelSingleProduct.value.singleVirtualProduct!.rating ==
                                '0'
                            ? Row(
                                mainAxisAlignment: MainAxisAlignment.end,
                                children: [
                            ...
                            : Text('No reviews'.tr),
                        if (modelSingleProduct
                            .value.singleVirtualProduct!.catId!.isNotEmpty)
                          Column(
                            children: [
                              const SizedBox(
                                height: 15,
                        ...
                        //         height: 28,
                        //         child: ListView.builder(
                        //           itemCount: modelSingleProduct.value
                        //               .singleVirtualProduct!.catId!.length,
                        //           shrinkWrap: true,
                        //           scrollDirection: Axis.horizontal,
                        //           physics:
                        //               const AlwaysScrollableScrollPhysics(),
                        ...
                        if (modelSingleProduct.value.singleVirtualProduct!
                                    .longDescription !=
                                '' &&
                            modelSingleProduct.value.singleVirtualProduct!
                                    .longDescription !=
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                int inStock = int.tryParse(modelSingleProduct
                                        .value.singleVirtualProduct!.inStock) ??
                                    0;
                                if (inStock == 0) {
