...
class _RequiredDocumentsScreenState extends State<RequiredDocumentsScreen> {
  ...
  final TextEditingController _corporateBankAccountController =
      TextEditingController();
      final TextEditingController _ibnNumberController =
      TextEditingController();
  ...
  void updateProfile() {
    ...
    map["company_bank_account"] = _corporateBankAccountController.text;
    map["iban_number"] = _ibnNumberController.text;
              ...
              Column(
                children: [
                  ...
                  Align(
                    ...
                    child: Text(
                      "Corporate Bank Account Name".tr,
                      style: GoogleFonts.poppins(
                  ...
                  CommonTextField(
                    controller: _corporateBankAccountController,
                    obSecure: false,
                    // hintText: 'Name',
                    hintText: "Corporate Bank Account".tr,
                    validator: (value) {
                       if (value!.isEmpty) {
                      return 'Please enter corporate bank account name'.tr;
                    }
                    return null;
                    },
                  ),
                  ...
                  8.spaceY,
                  CommonTextField(
                    controller: _ibnNumberController,
                    obSecure: false,
                    // hintText: 'Name',
                  ...
                  // ImageWidget(
                  //   // key: paymentReceiptCertificateKey,
                  //   title: "Corporate Bank Account".tr,
                  //   file: company_bank_account,
                  //   validation: checkValidation(showValidation.value, company_bank_account.path.isEmpty),
                  //   filePicked: (File g) {
                  //     company_bank_account = g;
